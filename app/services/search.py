...
class SearchHandler:
    ...
    def embed_text(self, text):
        ...
        with torch.no_grad():
            text_outputs = self.model.base_model.model.text_model(**inputs)
            text_embeds = text_outputs.pooler_output
            text_embeds = self.model.base_model.model.text_projection(text_embeds)
    ...
    def embed_image(self, image):
        ...
        with torch.no_grad():
            vision_outputs = self.model.base_model.model.vision_model(**inputs)
            image_embeds = vision_outputs.pooler_output
            image_embeds = self.model.base_model.model.visual_projection(image_embeds)
